...
describe('OutputPanel', () => {
    it('renders logs correctly', () => {
        (useStore as any).mockReturnValue({
            logs: [
                { id: '1', type: 'stdout', message: 'Hello World', timestamp: 1000 },
                { id: '2', type: 'stderr', message: 'Error happened', timestamp: 2000 },
            ],
            clearLogs: vi.fn()
        });
    ...
    it('renders system messages differently', () => {
        (useStore as any).mockReturnValue({
            logs: [
                { id: '3', type: 'system', message: 'System Ready', timestamp: 3000 }
            ],
            clearLogs: vi.fn()
        });
