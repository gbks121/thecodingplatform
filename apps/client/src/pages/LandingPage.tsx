...
import {
    ...
    InputLabel, Select, MenuItem, Stack, Grid, Paper, Card, CardContent,
        ...
        <Box sx={{
            ...
            <Container maxWidth="md" sx={{
                ...
                <Typography variant="h1" fontWeight="800" sx={{
                    ...
                    Code Together,<br /> Instantly.
                </Typography>

                <Typography variant="h5" color="text.secondary" sx={{ mb: 6, maxWidth: '600px', mx: 'auto', lineHeight: 1.6 }}>
                    Real-time collaborative code editor with instant execution, multi-language support, and integrated chat. No setup required.
                </Typography>
