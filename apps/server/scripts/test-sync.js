...
async function runTest() {
    ...
    await new Promise((resolve, reject) => {
        ...
        provider1.on('connection-error', (e) => reject('Provider 1 error: ' + e));
        provider2.on('connection-error', (e) => reject('Provider 2 error: ' + e));
    });
    ...
    const alice = Array.from(states.values()).find(s => s.user && s.user.name === 'Alice');
